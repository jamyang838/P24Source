...
#define ANDROID_DEMO_BUTTON_1           BUTTON_BTN2
#define ANDROID_DEMO_BUTTON_2           BUTTON_BTN3
#define ANDROID_DEMO_BUTTON_3           BUTTON_BTN4
#define ANDROID_DEMO_BUTTON_4           BUTTON_BTN5
